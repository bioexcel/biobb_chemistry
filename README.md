...
[![](https://img.shields.io/badge/docker-Quay.io-blue)](https://quay.io/repository/biocontainers/biobb_chemistry)
...
* Installation:
        ...
        pip install "biobb_chemistry>=3.7.0"
...
* Installation:
        ...
        conda install -c bioconda "biobb_chemistry>=3.7.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_chemistry:3.7.0--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_chemistry:3.7.0--pyhdfd78af_0 <command>
