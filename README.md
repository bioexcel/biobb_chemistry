...
[![](https://img.shields.io/badge/singularity-GalaxyProject-blue)](https://depot.galaxyproject.org/singularity/biobb_chemistry:3.8.0--pyhdfd78af_1)
...
* Installation:
        ...
        pip install "biobb_chemistry>=3.8.0"
...
* Installation:
        ...
        conda install -c bioconda "biobb_chemistry>=3.8.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_chemistry:3.8.0--pyhdfd78af_1


* Usage:


        docker run quay.io/biocontainers/biobb_chemistry:3.8.0--pyhdfd78af_1 <command>
...
* Installation:
        ...
        singularity pull --name biobb_chemistry.sif https://depot.galaxyproject.org/singularity/biobb_chemistry:3.8.0--pyhdfd78af_1
