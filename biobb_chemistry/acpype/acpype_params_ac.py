...
class AcpypeParamsAC():
    ...
    def check_data_params(self):
        ...
        self.output_path_frcmod = check_output_path(self.output_path_frcmod, 'frcmod', out_log)
        self.output_path_inpcrd = check_output_path(self.output_path_inpcrd, 'inpcrd', out_log)
        self.output_path_lib = check_output_path(self.output_path_lib, 'lib', out_log)
        self.output_path_prmtop = check_output_path(self.output_path_prmtop, 'prmtop', out_log)
        self.output_files = {
