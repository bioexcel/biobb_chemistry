...
* **obminimize_path** (*string*): (obminimize) Path to the obminimize executable binary..
...
acpype_params_ac -h
```
    /bin/sh: acpype_params_ac: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
* **acpype_path** (*string*): (acpype) Path to the acpype executable binary..
* **remove_tmp** (*boolean*): (True) Remove temporal files..
* **restart** (*boolean*): (False) Do not execute if output files exist..
* **container_path** (*string*): (None) Container path definition..
...
* **ph** (*number*): (None) Add hydrogens appropriate for pH..
* **obabel_path** (*string*): (obabel) Path to the obabel executable binary..
* **remove_tmp** (*boolean*): (True) Remove temporal files..
* **restart** (*boolean*): (False) Do not execute if output files exist..
* **container_path** (*string*): (None) Container path definition..
* **container_image** (*string*): (informaticsmatters/obabel:latest) Container image definition..
...
```
    /bin/sh: acpype_params_gmx_opls: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
acpype_params_cns -h
```
    /bin/sh: acpype_params_cns: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
* **reduce_path** (*string*): (reduce) Path to the reduce executable binary..
* **remove_tmp** (*boolean*): (True) Remove temporal files..
* **restart** (*boolean*): (False) Do not execute if output files exist..
* **container_path** (*string*): (None) Container path definition..
...
acpype_params_gmx -h
```
    /bin/sh: acpype_params_gmx: command not found
### I / O Arguments
Syntax: input_argument (datatype) : Definition
